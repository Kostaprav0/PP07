...
namespace Бетон2
{
    public class CreateUserForm : Form
    {
        ...
        private void InitializeComponents()
        {
            ...
            this.Size = new Size(400, 300); // Увеличили высоту для метки
            ...
            // Метка для отображения статуса паролей
            ...
            createButton.Enabled = false; // Изначально отключена
        ...
        private void ValidateForm(object sender, EventArgs e)
        {
            ...
            // Активация кнопки только при выполнении всех условий
