...
using Microsoft.VisualBasic; // Добавлена эта директива
...
namespace Бетон2
{
    public class UsersControl : UserControl
    {
        ...
        private void CreateDatabaseRole()
        {
            try
            {
                var roleName = Interaction.InputBox( // Теперь этот вызов будет работать
